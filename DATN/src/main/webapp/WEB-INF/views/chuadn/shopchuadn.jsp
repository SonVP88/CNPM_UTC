...
<div class="cps-container cps-body">
   ...
   <div id="search-catalog-page">
      ...
      <div class="search-sort mb-2" id="sortSearch" style="">
         ...
         <strong>${count}</strong> sản phẩm cho từ
         khoá
         <strong>${keytimkiem}</strong>
      </h1>
         </div>
    ...
    <div class="product-info-container product-item">
        <div class="product-info">
            <a rel="" href="/san-pham/${sp.tenSanPham}" class="product__link button__link">
                ...
                <div class="product__name">
                    <h3>${sp.tenSanPham} ${sp.dungLuong}</h3>
                </div>
                    ...
                    <div class="box-info__box-price">
                        ...
                        <c:choose>
                            <c:when test="${sp.giaSauKhiGiam != null}">
                                <!-- Giá sau giảm -->
                                <p class="product__price--show" style="color:red; font-weight:bold;">
                                    ${sp.giaSauKhiGiam}đ
                                </p>

                                <!-- Giá gạch -->
                                <p style="text-decoration:line-through; color:#555;">
                                    ${sp.giaBan}đ
                                </p>
                            </c:when>
        ...
        <div class="install-0-tag">
            ...
            <div class="has-text-centered">
               <button class="button load-more-btn" fdprocessedid="ni5sbg">
                  Xem thêm 5491 sản phẩm
